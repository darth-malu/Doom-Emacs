...
#+begin_src emacs-lisp :tangle yes
(custom-set-faces!
  '(mode-line :family "Mononoki Nerd Font" :size 16 )
  '(mode-line-inactive :family "Quicksand" :size 17))
#+end_src
...
centaur-tabs-style "bar" : https://github.com/ema2159/centaur-tabs?tab=readme-ov-file#tab-styles
...
(use-package! org-capture
  ...
  (setq org-capture-templates
        ...
        ;;; MY STUFF
          ...
          ("t" "TESt" checkitem
           (file+olp "test.org" "Heading" "2 test")
           "+ [ ] %?")
