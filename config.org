...
(use-package org-capture
  ...
  (setq org-capture-templates
      '(
        ...
        ;; ("g" "Games template" plain
        ;;   (file+headline "bucket-list.org" "Games to play");
        ;;   "- [ ] %?")

        ;; ("b" "Books template" plain
        ;;   (file+headline "bucket-list.org" "Books to read")
        ;;   "- [ ] %?")
